		  ...
		  <div class="tamanho">
			...
			<div id="logo">
				...
				@if ($current->course == 'Biologia')
							<a href="/" title="Ir para Início"><img alt="Ir para Início" src="{{ asset('/icons/ufes-preto.svg') }}"></a>
				@else
							<a href="/" title="Ir para Início"><img alt="Ir para Início" src="{{ asset('/icons/ufes-branco.svg') }}"></a>
				@endif
